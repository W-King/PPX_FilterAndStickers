...
@interface PPXPasterStageView () <PPXPasterViewDelegate>
{
    CGPoint         startPoint ;
    CGPoint         touchPoint ;
...
@property (nonatomic,strong) PPXPasterView   *pasterCurrent ;
@property (nonatomic)        int            newPasterID ;

@end

@implementation PPXPasterStageView
...
- (void)setPasterCurrent:(PPXPasterView *)pasterCurrent
{
...
- (void)addPasterWithImg:(UIImage *)imgP
{
    ...
    self.pasterCurrent = [[PPXPasterView alloc] initWithBgView:self
...
- (void)clearAllOnFirst
{
    ...
    [m_listPaster enumerateObjectsUsingBlock:^(PPXPasterView *pasterV, NSUInteger idx, BOOL * _Nonnull stop) {
